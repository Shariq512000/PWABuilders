...
function App() {
  ...
  const getAllProducts = async () => {
    try {
      const response = await axios.get(`https://shopping-app-with-mongodb.cyclic.app//products`)
  ...
  let deleteProduct = async (id) => {
    try {
      const response = await axios.delete(`https://shopping-app-with-mongodb.cyclic.app//product/${id}`)
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      axios.post(`https://shopping-app-with-mongodb.cyclic.app//product`, {
  ...
  const editFormik = useFormik({
    ...
    onSubmit: (values) => {
      console.log("values: ", values);
      setClickEdit(!clickEdit);
      axios.put(`https://shopping-app-with-mongodb.cyclic.app//product/${currentProduct._id}`, {
      ...
      <div style={{ alignSelf: "center" }}>
        {products?.map((eachProduct, i) => (
          <div key={i} className="card">
            ...
            {
              (clickEdit && currentProduct._id === eachProduct._id) ? <IconButton aria-label="cancel" size="large" color="orange" style={{ color: "orange" }} onClick={() => {
            ...
            {
              (clickEdit && currentProduct._id === eachProduct._id) ?
                <div>
